...
"border-radius: 5px;")
        ...
        self.lista_mat_referencia = QListWidget(self.frame)
        self.lista_mat_referencia.setObjectName(u"lista_mat_referencia")
        self.lista_mat_referencia.setFocusPolicy(Qt.NoFocus)
        self.lista_mat_referencia.setSelectionMode(QAbstractItemView.ExtendedSelection)

        self.verticalLayout_9.addWidget(self.lista_mat_referencia)

        self.splitter_2.addWidget(self.frame)
        self.tabela_mat_referencia = QTableWidget(self.splitter_2)
        self.tabela_mat_referencia.setObjectName(u"tabela_mat_referencia")
        self.tabela_mat_referencia.setFocusPolicy(Qt.NoFocus)
        self.tabela_mat_referencia.setStyleSheet(u"")
        self.tabela_mat_referencia.setFrameShadow(QFrame.Sunken)
        self.tabela_mat_referencia.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tabela_mat_referencia.setTextElideMode(Qt.ElideNone)
        self.tabela_mat_referencia.setGridStyle(Qt.SolidLine)
        self.tabela_mat_referencia.setCornerButtonEnabled(False)
        self.tabela_mat_referencia.setRowCount(0)
        self.tabela_mat_referencia.setColumnCount(0)
        self.splitter_2.addWidget(self.tabela_mat_referencia)
        self.tabela_mat_referencia.horizontalHeader().setCascadingSectionResizes(False)
        self.tabela_mat_referencia.horizontalHeader().setMinimumSectionSize(50)
        self.tabela_mat_referencia.horizontalHeader().setDefaultSectionSize(100)
        self.tabela_mat_referencia.horizontalHeader().setStretchLastSection(True)
        self.tabela_mat_referencia.verticalHeader().setVisible(True)
        self.tabela_mat_referencia.verticalHeader().setCascadingSectionResizes(False)
        self.tabela_mat_referencia.verticalHeader().setStretchLastSection(True)
...
"border-radius: 5px;")
        ...
        self.lista_amostras_corrigidas = QListWidget(self.frame_2)
        self.lista_amostras_corrigidas.setObjectName(u"lista_amostras_corrigidas")
        self.lista_amostras_corrigidas.setFocusPolicy(Qt.NoFocus)
        self.lista_amostras_corrigidas.setSelectionMode(QAbstractItemView.ExtendedSelection)
        self.lista_amostras_corrigidas.setSelectionRectVisible(False)

        self.verticalLayout_10.addWidget(self.lista_amostras_corrigidas)

        self.splitter_3.addWidget(self.frame_2)
        self.tabela_amostras_corrigidas = QTableWidget(self.splitter_3)
        self.tabela_amostras_corrigidas.setObjectName(u"tabela_amostras_corrigidas")
        self.tabela_amostras_corrigidas.setFocusPolicy(Qt.NoFocus)
        self.tabela_amostras_corrigidas.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tabela_amostras_corrigidas.setTextElideMode(Qt.ElideNone)
        self.tabela_amostras_corrigidas.setCornerButtonEnabled(False)
        self.tabela_amostras_corrigidas.setRowCount(0)
        self.tabela_amostras_corrigidas.setColumnCount(0)
        self.splitter_3.addWidget(self.tabela_amostras_corrigidas)
        self.tabela_amostras_corrigidas.horizontalHeader().setMinimumSectionSize(100)
        self.tabela_amostras_corrigidas.horizontalHeader().setDefaultSectionSize(100)
        self.tabela_amostras_corrigidas.horizontalHeader().setStretchLastSection(True)
        self.tabela_amostras_corrigidas.verticalHeader().setVisible(True)
        self.tabela_amostras_corrigidas.verticalHeader().setStretchLastSection(True)
